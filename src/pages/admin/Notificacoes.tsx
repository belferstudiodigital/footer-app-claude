...
export default function Notificacoes() {
  ...
  async function gerarEEnviarAviso() {
    ...
    try {
      ...
      let texto = `⚽ *${timeAtual.nome}* — E aí, craques!\n\n`
      texto += `${formatDataPorExtenso(jogoAtual.data_jogo)}, ${formatHora(jogoAtual.horario_inicio)}\n`
      texto += `📍 ${jogoAtual.local}\n\n`
      texto += `Confirme presença: ${link}\n`
