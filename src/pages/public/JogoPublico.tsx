...
import stickerChute from '../../assets/sticker-chute.png'
      ...
      <div className="max-w-lg mx-auto px-4 pt-6">
        ...
        {!bloqueado && !prazoExpirado && (
          <Card className="mb-4">
            ...
            {mensagem && (
              <div className="mb-3 flex items-center gap-2 rounded-xl border border-lime/30 bg-lime/10 px-3.5 py-2.5 text-sm text-lime">
                <img src={stickerChute} alt="" aria-hidden="true" className="h-8 w-8 shrink-0 object-contain" />
                {mensagem}
              </div>
            )}
